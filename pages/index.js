...
//                   className="text-white bg-[#ef8e38] hover:bg-[#ef7b38] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-2.5 me-2 mb-2"
//                 >
//                   Tour
//                 </button>
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (tourButton) {
      setTimeout(() => {
        tourButton.classList.remove("animate-bounce");
      }, 3000);
    }
  }, [count]);
      ...
      steps: [
        ...
        },
        {
          ...
          popover: {
            title: "Uploaded Files",
            description:
              "View and select your uploaded pdf files from here to chat.",
            side: "right",
            align: "middle",
          },
        },
            ...
            <div className={"grid lg:grid-cols-2 gap-8 h-[inherit]"}>
              ...
              <div className="chatbox">
                <button
                  id="tourButton"
                  onClick={handleTourStart}
                  className="text-white bg-[#ef8e38] hover:bg-[#ef7b38] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-2.5 me-2 mb-2 animate-bounce duration-500 infinite tour-button"
                >
                  Tour
                </button>
